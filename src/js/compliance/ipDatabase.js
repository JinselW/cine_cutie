...
const CHARACTER_IP = [
  ...
  { id: 'ip002', name: 'Mario', type: IPType.CHARACTER, owner: 'Nintendo', aliases: ['super mario', 'mario bros'], keywords: ['plumber', 'red cap', 'red hat', 'blue overalls', 'power mushroom', 'super star', 'fire flower'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip005', name: 'Superman', type: IPType.CHARACTER, owner: 'DC Comics', aliases: ['super man', 'clark kent', 'man of steel'], keywords: ['s symbol', 'red cape', 'blue suit', 'red boots', 'metropolis', 'fortress of solitude'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip010', name: 'Hulk', type: IPType.CHARACTER, owner: 'Marvel', aliases: ['incredible hulk', 'bruce banner', 'the hulk'], keywords: ['green skin', 'huge muscles', 'hulk smash', 'gamma rage'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip013', name: 'Sonic The Hedgehog', type: IPType.CHARACTER, owner: 'Sega', aliases: ['sonic'], keywords: ['blue hedgehog', 'red shoes', 'golden rings', 'super speed', 'spin dash'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip015', name: 'Doraemon', type: IPType.CHARACTER, owner: 'Shin-Ei Animation / Fujiko F. Fujio', aliases: ['doraemon cat', 'machine cat'], keywords: ['blue robot cat', 'fourth dimensional pocket', 'copper bell', 'no ears', 'round body'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip023', name: 'Snow White', type: IPType.CHARACTER, owner: 'Disney', aliases: ['snow white princess'], keywords: ['seven dwarfs', 'poisoned apple', 'evil queen', 'magic mirror', 'blue and yellow dress'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  { id: 'ip024', name: 'Rapunzel', type: IPType.CHARACTER, owner: 'Disney', aliases: ['tangled rapunzel'], keywords: ['long golden hair', 'frying pan', 'tall tower prison', 'floating lights', 'purple dress'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip028', name: 'Peter Pan', type: IPType.CHARACTER, owner: 'Disney', aliases: ['peter pan boy'], keywords: ['flying boy', 'neverland', 'tinker bell', 'lost boys', 'captain hook', 'green tights'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip031', name: 'Piglet', type: IPType.CHARACTER, owner: 'Disney / A.A. Milne', aliases: ['piglet pig'], keywords: ['small pig', 'pink striped shirt', 'scarf', 'timid', 'hundred acre wood'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip038', name: 'Wall-E', type: IPType.CHARACTER, owner: 'Pixar', aliases: ['wall e', 'walle'], keywords: ['trash robot', 'compactor', 'eve', 'small green plant', 'binocular eyes'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  { id: 'ip039', name: 'Olaf', type: IPType.CHARACTER, owner: 'Disney', aliases: ['olaf snowman'], keywords: ['snowman', 'carrot nose', 'love summer', 'warm hugs', 'stick arms'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip045', name: 'Puss in Boots', type: IPType.CHARACTER, owner: 'DreamWorks', aliases: ['puss in boots cat'], keywords: ['orange cat', 'boots', 'hat with feather', 'sword', 'shrek', 'spanish accent'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  ...
  { id: 'ip050', name: 'Squirtle', type: IPType.CHARACTER, owner: 'Nintendo / The Pokémon Company', aliases: ['squirtle turtle'], keywords: ['turtle', 'water gun', 'shell on back', 'blue turtle', 'pokémon'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
  { id: 'ip051', name: 'Bulbasaur', type: IPType.CHARACTER, owner: 'Nintendo / The Pokémon Company', aliases: ['bulbasaur dinosaur'], keywords: ['bulb on back', 'green dinosaur', 'vine whip', 'seed bulb', 'pokémon'], policy: { riskLevel: 'HIGH', maxAction: 'BLOCK' } },
];
