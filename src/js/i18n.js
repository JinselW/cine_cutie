...
const en = {
  ...
  'promptAgent.revised': 'Revised shot {shot}; prompt package v{version} is ready.',
  ...
  'promptAgent.qcPassed': 'Prompt quality score: {score}/10 — passed.',
  'promptAgent.providerDegraded': '{provider} adapted the {media} prompt with limitations: {reason}',
  'promptAgent.imageUsingPackage': 'Image Director is using prompt package v{version}.',
  'promptAgent.videoPackageRebuilt': 'The saved prompt package no longer matches the current inputs; Video Director rebuilt a compatible package.',
  'promptAgent.videoUsingPackage': 'Video Director is using prompt package v{version}.',
...
const zh = {
  ...
  'promptAgent.revised': '镜头 {shot} 已修订，提示词包已更新至 v{version}。',
  ...
  'promptAgent.qcPassed': '提示词质量评分：{score}/10，已通过。',
  'promptAgent.providerDegraded': '{provider} 在适配{media}提示词时存在能力限制：{reason}',
  'promptAgent.imageUsingPackage': '图像导演正在使用提示词包 v{version}。',
  'promptAgent.videoPackageRebuilt': '已有提示词包与当前输入不兼容，视频导演已按分镜重建兼容包。',
  'promptAgent.videoUsingPackage': '视频导演正在使用提示词包 v{version}。',
